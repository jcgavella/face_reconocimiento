...
## Pero no elimines estos creditos, gracias.
...
NumeroFotos = int(input("Cuantas fotos deseas realizar?\n"))

count = 0
while count < NumeroFotos:
    (rval, im) = webcam.read()
    im = cv2.flip(im, 1, 0)
...
Mod = input('Desea entrenar el modelo? y/n\n')
if Mod == y:
